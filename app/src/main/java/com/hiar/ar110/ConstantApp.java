...
public class ConstantApp {
    ...
    //chat
    public final static String CHAT_GROUP_ID_KEY = "group_id";
    public final static String CHAT_GROUP_NAME_KEY = "group_name";
    public final static String CHAT_TYPE_KEY = "chat_type";
    public final static String CHAT_RC_ID_KEY = "rc_id";

    public static final int MAX_FETCH_NUM = 10;

    public static final class BroadcastAction {
        public final static String ACTION_PSTORE_EXIT =
                cn.com.cybertech.pdk.Intent.ACTION_PSTORE_EXIT;
    }
...
//        public static final int MSG_COPTASK_ADD = 103;
//        public static final int MSG_LOCATION_UPDATE = 104;
        public static final int MSG_HILEIA_CALLING_CALLBACK = 105;
        public static final int MSG_HILEIA_LOGIN_CALLBACK = 106;
        public static final int MSG_HILEIA_HANGUP_CALLBACK = 107;
    }
}
