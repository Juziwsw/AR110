...
abstract class AbstractUVCCameraHandler extends Handler {
    ...
    private static final int MSG_CAPTURE_AUDIO_START = 6;
    private static final int MSG_CAPTURE_STOP = 7;
    private static final int MSG_MEDIA_UPDATE = 8;
    ...
    public void setFrameCallback(IFrameCallback frameCallback) {
        final CameraThread thread = mWeakThread.get();
        if (thread != null) {
            thread.setFrameCallbackExt(frameCallback);
        }
    }
    ...
    public void startAudioRecording(final String path) {
        checkReleased();
        sendMessage(obtainMessage(MSG_CAPTURE_AUDIO_START, path));
    }
    ...
    public void handleMessage(final Message msg) {
        ...
        switch (msg.what) {
            ...
            case MSG_CAPTURE_START:
                ...
                break;
            case MSG_CAPTURE_AUDIO_START:
                thread.handleStartAudioRecording((String) msg.obj);
                break;
    ...
    static final class CameraThread extends Thread {
        ...
        private IFrameCallback mIFrameCallbackExt;
...
//            mUVCCamera.updateCameraParams();
        ...
        public void handleStartRecording(String path) {
            if (DEBUG) Log.v(TAG_THREAD, "handleStartRecording: mEncoderType mEncoderType="+mEncoderType);
            try {
        ...
        public void handleStartAudioRecording(String path) {
        ...
        public void setFrameCallbackExt(IFrameCallback frameCallback) {
            mIFrameCallbackExt = frameCallback;
        }

        private final IFrameCallback mIFrameCallback = new IFrameCallback() {

            @Override
            public void onFrame(ByteBuffer frame, long l) {
                ...
                if (mIFrameCallbackExt != null) {
                    mIFrameCallbackExt.onFrame(frame,l);
                }
            }
        };
