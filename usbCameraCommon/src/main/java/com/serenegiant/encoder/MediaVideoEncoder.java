...
public class MediaVideoEncoder extends MediaEncoder implements IVideoEncoder {
    ...
    private EGLBase.IEglSurface eglSurface;
    ...
    private void draw(final float[] tex_matrix) {
        eglSurface.makeCurrent();
        GLES20.glClear(GLES20.GL_COLOR_BUFFER_BIT);
        GLES20.glViewport(0, 0, mWidth, mHeight);
        glDrawer2D.draw(textureId, tex_matrix, 0);
        eglSurface.swap();
    }
    ...
    public void setEglContext(final EGLBase.IContext sharedContext, final int tex_id) {
        textureId = tex_id;
        eglBase = EGLBase.createFrom(sharedContext, false, true);
        eglSurface = eglBase.createFromSurface(mSurface);
        eglSurface.makeCurrent();
        glDrawer2D = new GLDrawer2D(false);
    }
