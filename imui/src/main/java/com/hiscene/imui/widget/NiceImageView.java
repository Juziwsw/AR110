...
import com.hiscene.imui.util.DeviceUtil;
...
public class NiceImageView extends AppCompatImageView {
    ...
    private void refreshTextSizeConfig() {
        ...
        mCenterY = (int) (paddingTop + Math.max(width, height) / 2.0f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int sc = canvas.saveLayer(srcRectF, null, Canvas.ALL_SAVE_FLAG);
        if (!mIsCoverSrc) {
    ...
    public void setTextAndBgColor(String text, int bgColor) {
    ...
    public void setTextAndColorSeed(String colorSeed) {
        String text = StringUtils.getAvatarShowString(colorSeed);
        setTextAndBgColor(text, getColorBySeed(colorSeed));
    }

    public void setTextSeed(String colorSeed) {
        String text = StringUtils.getAvatarShowString(colorSeed);
        setTextAndBgColor(text, getColorBySeed(colorSeed));
        //setText(text);
    }
    ...
    public void setBorderWidth(int borderWidth) {
        this.mBorderWidth = DeviceUtil.dip2px(borderWidth);
    ...
    public void setInnerBorderWidth(int innerBorderWidth) {
        this.mInnerBorderWidth = DeviceUtil.dip2px(innerBorderWidth);
        clearInnerBorderWidth();
        invalidate();
    }
    ...
    public void setCornerRadius(int cornerRadius) {
        this.mCornerRadius = DeviceUtil.dip2px(cornerRadius);
        calculateRadiiAndRectF(false);
    }

    public void setCornerLeftRadius(int cornerLeftRadius) {
        this.mCornerTopLeftRadius = DeviceUtil.dip2px(cornerLeftRadius);
        this.mCornerTopRightRadius = 0;
        this.mCornerBottomRightRadius = 0;
        this.mCornerBottomLeftRadius = DeviceUtil.dip2px(cornerLeftRadius);
        calculateRadiiAndRectF(true);
    }

    public void setCornerRightRadius(int cornerRightRadius) {
        this.mCornerTopLeftRadius = 0;
        this.mCornerTopRightRadius = DeviceUtil.dip2px(cornerRightRadius);
        this.mCornerBottomRightRadius = DeviceUtil.dip2px(cornerRightRadius);
        this.mCornerBottomLeftRadius = 0;
        calculateRadiiAndRectF(true);
    }

    public void setCornerTopLeftRadius(int cornerTopLeftRadius) {
        this.mCornerTopLeftRadius = DeviceUtil.dip2px(cornerTopLeftRadius);
        this.mCornerTopRightRadius = 0;
        this.mCornerBottomLeftRadius = 0;
        this.mCornerBottomRightRadius = 0;
        calculateRadiiAndRectF(true);
    ...
    public void setCornerTopRightRadius(int cornerTopRightRadius) {
        this.mCornerTopLeftRadius = 0;
        this.mCornerTopRightRadius = DeviceUtil.dip2px(cornerTopRightRadius);
        this.mCornerBottomLeftRadius = 0;
        this.mCornerBottomRightRadius = 0;
        calculateRadiiAndRectF(true);
    }
    ...
    public void setCornerBottomLeftRadius(int cornerBottomLeftRadius) {
        this.mCornerTopLeftRadius = 0;
        this.mCornerTopRightRadius = 0;
        this.mCornerBottomLeftRadius = DeviceUtil.dip2px(cornerBottomLeftRadius);
        this.mCornerBottomRightRadius = 0;
        calculateRadiiAndRectF(true);
    }
    ...
    public void setCornerBottomRightRadius(int cornerBottomRightRadius) {
        ...
        this.mCornerTopRightRadius = 0;
        this.mCornerBottomLeftRadius = 0;
        this.mCornerBottomRightRadius = DeviceUtil.dip2px(cornerBottomRightRadius);
        calculateRadiiAndRectF(true);
    }
