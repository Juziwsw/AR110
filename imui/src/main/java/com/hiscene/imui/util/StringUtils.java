...
public class StringUtils {
    ...
    public static <T> boolean equals(final T value1, final T value2) {
        ...
        if (value1 != null && value2 != null) {
            try {
                ...
                Log.e(TAG, "equals: " + e.getLocalizedMessage());
            }
            return false;
        }
        // 防止两个值都为 null
    ...
    public static int countMatches(final String str, final String keyword) {
        ...
        try {
            ...
            Log.e(TAG, "countMatches: " + e.getLocalizedMessage());
        }
        return -1;
    }
    ...
    public static int countMatches2(final String str, final String keyword) {
        ...
        try {
            ...
            Log.e(TAG, "countMatches2: " + e.getLocalizedMessage());
        }
        return -1;
    }
    ...
    public static String getFormatString(final String format, final Object... args) {
        ...
        try {
            ...
            Log.e(TAG, "getFormatString: " + e.getLocalizedMessage());
        }
        return null;
    }
    ...
    public static String getFormatString2(final String format, final Object... args) {
        ...
        try {
            ...
            Log.e(TAG, "getFormatString2: " + e.getLocalizedMessage());
        }
        return null;
    }
    ...
    public static String getAutoFormatString(final Object... args) {
        if (args != null && args.length != 0) {
            try {
                ...
                Log.e(TAG, "getAutoFormatString: " + e.getLocalizedMessage());
            }
        }
        return null;
    }
    ...
    public static String getAutoFormatString2(final Object... args) {
        if (args != null && args.length != 0) {
            try {
                ...
                Log.e(TAG, "getAutoFormatString2: " + e.getLocalizedMessage());
            }
        }
        return null;
    }
    ...
    public static String toStrEncode(final String str, final String enc) {
        ...
        try {
            ...
            Log.e(TAG, "toStrEncode: " + e.getLocalizedMessage());
        }
        return str;
    }
    ...
    public static String toUrlEncode(final String str, final String enc) {
        ...
        try {
            ...
            Log.e(TAG, "toUrlEncode: " + e.getLocalizedMessage());
        }
        return null;
    }
    ...
    public static String toASCII(final String str) {
        ...
        try {
            ...
            Log.e(TAG, "toASCII: " + e.getLocalizedMessage());
        }
        return null;
    }
    ...
    public static String toUnicode(final String str) {
        ...
        try {
            ...
            Log.e(TAG, "toUnicode:" + e.getLocalizedMessage());
        }
        return null;
    }
    ...
    public static String toUnicodeString(final char[] chars) {
        ...
        try {
            ...
            Log.e(TAG, "toUnicodeString: " + e.getLocalizedMessage());
        }
        return null;
    }
    ...
    public static String upperFirstLetter(final String str) {
        ...
        try {
            ...
            Log.e(TAG, "upperFirstLetter: " + e.getLocalizedMessage());
            return str;
        }
    }
    ...
    public static String lowerFirstLetter(final String str) {
        ...
        try {
            ...
            Log.e(TAG, "lowerFirstLetter: " + e.getLocalizedMessage());
            return str;
        }
    }
    ...
    public static List<String> getStrList2(String content, int len) {  //字符串对象，分割长度
